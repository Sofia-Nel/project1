...
tabela<-summary_table(Biedronki, summaries = raport, by = c('Customer type'))
...
tabela<-summary_table(Biedronki, summaries = raport, by = c('Product line'))

kbl(tabela, digits = 3,
  caption="Table 1. Biedronki - gross income in kPLN by type of product line.") %>% kable_classic(full_width = F, html_font = "Cambria")%>% kable_styling(bootstrap_options = c("striped", "hover"))
