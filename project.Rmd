...
kbl(tabela, digits = 2,
  caption="Table 1. Biedronki - gross income in kPLN by type of payment.",  col.names = c('Cash', 'Credit card', 'Ewallet')) %>% kable_classic(full_width = F, html_font = "Cambria")%>% kable_styling(bootstrap_options = c("striped", "hover"))
```
